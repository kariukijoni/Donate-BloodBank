            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="panel panel-default">
                        <div class="panel-heading">Change password rules
                            <?php
                        ...
                        <ul style="list-style-type: disc">
                            <li>Enter the Old Password in Old Password text field</li>
                            <li>Second Enter your desired New Password</li>
                            <li>Thirdly Confirm your new Password</li>
                            <li>Finally do submission</li>
                        </ul>
                    </div>
                </div>
            </div>

    ...
    DateRangePicker.prototype = {
        ...
        renderCalendar: function (calendar, selected, minDate, maxDate, side) {
            ...
            if (!minDate || minDate.isBefore(calendar.firstDay)) {
                html += '<th class="prev available"><i class="fa fa-arrow-left icon fa fa-chevron-left glyphicon glyphfa fa-chevron-left"></i></th>';
            } else {
                html += '<th></th>';
            }
            ...
            if (!maxDate || maxDate.isAfter(calendar.lastDay)) {
                html += '<th class="next available"><i class="fa fa-arrow-right icon fa fa-chevron-right glyphicon glyphfa fa-chevron-right"></i></th>';
            } else {
                html += '<th></th>';
            }
